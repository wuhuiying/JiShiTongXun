...
import com.example.administrator.kejibeidou.Util.BitmapHelper;
import com.example.administrator.kejibeidou.View.Custom.QuickOptionDialog;
 ...
 * 上传头像封装 必须使用这个adapter监听actvityresult方法 执行adapter.onActivityResult(requestCode, resultCode, data)
 */
